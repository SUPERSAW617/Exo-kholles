...
\begin{exercise}
Soit $(x_n)_{\in\N}$ une suite de rééls telle que :
...
On pose $S_{n,p}=\sume_{k=0}^nk^p$. Déterminer les entiers naturels non nuls $p$ tels que, pour tout $n\ge0$, $S_{n,p}$ soit le carré d'un entier naturel.
\end{exercise}
